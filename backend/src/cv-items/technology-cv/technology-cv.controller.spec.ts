...
describe('TechnologyCvController', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [{ provide: TechnologyCvService, useValue: mockService }],
    }).compile();
  ...
  it('addToCv deleguje do serwisu', async () => {
    ...
    await controller.addToCv(1, 5, { technologyId: 2 });
    expect(mockService.addToCv).toHaveBeenCalledWith(1, { technologyId: 2 }, 5);
  });
