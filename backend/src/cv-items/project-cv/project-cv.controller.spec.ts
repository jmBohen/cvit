...
describe('ProjectCvController', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [{ provide: ProjectCvService, useValue: mockService }],
    }).compile();
  ...
  it('addToCv deleguje do serwisu', async () => {
    ...
    await controller.addToCv(1, 5, { projectId: 2 });
    expect(mockService.addToCv).toHaveBeenCalledWith(1, { projectId: 2 }, 5);
  });
